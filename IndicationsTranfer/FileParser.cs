...
namespace IndicationsTranfer
{
    ...
    {
        public static List<(List<DateTime>, List<double>[])> Parse(List<string> paths)
        {
            List<(List<DateTime>, List<double>[])> graphics = new List<(List<DateTime>, List<double>[])>();
